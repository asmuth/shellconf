...
function s:initialize()
  ...
  call l9#defineVariableDefault('g:fuf_file_exclude'    , '\v\~$|\.(o|exe|dll|bak|orig|sw[po])$|(^|[/\\])(\.hg|\.bzr|3rdparty|build)($|[/\\])')
  "---------------------------------------------------------------------------
  ...
  call l9#defineVariableDefault('g:fuf_coveragefile_exclude'    , '\v\~$|\.(o|exe|dll|bak|orig|sw[po])$|(^|[/\\])\.(hg|bzr|.git)($|[/\\])')
  ...
  call l9#defineVariableDefault('g:fuf_dir_exclude'    , '\v(^|[/\\])(\.hg|\.bzr|\.git)($|[/\\])')
  "---------------------------------------------------------------------------
